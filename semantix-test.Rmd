...
Para realizar essa análise, construímos o gráfico abaixo. Ele mostra os mesmos dados do gráfico da pergunta anterior, mas agora com os valores do eixo y escaladas em razão da sua distância para a média. O valor 0 no eixo y representa a média, e cada unidade no dito eixo representa um desvio padrão. Vemos que 5 ligações é o último valor para o qual a porcentagem de aceites se mantêm acima da média. Com isso, estabelecemos 5 como um valor razoável para a quantidade máxima de ligações.
